...
const serverSet = function serverSet(port) {
  ...
  const fileUtils = require("./module/basic/server/fileUtils.js");
  const getMethod = require("./module/get/getMethod.js");
  const postMethod = require("./module/post/postMethod.js");
  const logErr = require("./module/basic/logErr.js");
