 ...
 */
const reqUrlSet = require("./postMethod/reqEvent/reqUrlSet");
const reqFunctionSet = require("./postMethod/reqEvent/reqFunctionSet");

function postMethod(req, res) {
  reqUrlSet(req, res, "write", reqFunctionSet.functionWrite);
  reqUrlSet(req, res, "html/sak", reqFunctionSet.functionSak);
  ...
  reqUrlSet(req, res, "html/su", reqFunctionSet.functionSu);
